...
namespace NewByteKnight.Service
{
    ...
    public interface IService
    {
        ...
        [WebInvoke(Method = "POST", BodyStyle = WebMessageBodyStyle.Wrapped, ResponseFormat = WebMessageFormat.Json,
            RequestFormat = WebMessageFormat.Json)]
        Response<List<CellVector>> DecodeSolverResult(string encodingType, string projectName,
                                                      string solverResultFileName);
        ...
        [WebInvoke(Method = "POST", BodyStyle = WebMessageBodyStyle.Wrapped, ResponseFormat = WebMessageFormat.Json,
            RequestFormat = WebMessageFormat.Json)]
        Response<bool> SetStartEndForPathPlanning(List<CellVector> startEndPoints);

        [WebInvoke(Method = "POST", BodyStyle = WebMessageBodyStyle.Wrapped, ResponseFormat = WebMessageFormat.Json,
            RequestFormat = WebMessageFormat.Json)]
        Response<List<CellVector>> ShowPath();
    };
}
